...
2. If this is a new install, Import the repairstatus.sql file using phpMyAdmin or equiv. If this is an upgrade, use the upgradeXX-XX.sql file
   ...
   you are upgrading from 1.0 to 1.3, import upgrade10-11.sql, upgrade11-12.sql and upgrade 12-13.sql. See the pattern? :)
